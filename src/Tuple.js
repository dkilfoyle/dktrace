...
export class Tuple {
  ...
  equals(other) {
    if (!(other instanceof Tuple)) {
      throw new RtError(
        ...
        "Tuple equals can only accept a Tuple"
      );
    }
  ...
  subtract(other) {
    if (this.w === TupleTypes.Vector && other.w === TupleTypes.Point) {
      throw new RtError(
        RtError.Code.INVALID_TYPE,
        "Can not subtract Point from Vector"
      );
    }
  ...
  magnitude() {
    if (this.w !== TupleTypes.Vector) {
      throw new RtError(
        RtError.Code.INVALID_TYPE,
        "Magnitude can only be used with vectors"
      );
    }
  ...
  normalize() {
    if (this.w !== TupleTypes.Vector) {
      throw new RtError(
        RtError.Code.INVALID_TYPE,
        "Normalize can only be used with vectors"
      );
    }
  ...
  dotProduct(other) {
    if (this.w !== TupleTypes.Vector || other.w !== TupleTypes.Vector) {
      throw new RtError(
        RtError.Code.INVALID_TYPE,
        "dotProduct can only be used with vectors"
      );
    }
